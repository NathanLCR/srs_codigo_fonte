...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r58.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r65); var ctx_r64 = ɵngcc0.ɵɵnextContext(); return ctx_r64.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r59 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r59.rows)("first", ctx_r59.first)("totalRecords", ctx_r59.totalRecords)("pageLinkSize", ctx_r59.pageLinks)("alwaysShow", ctx_r59.alwaysShowPaginator)("rowsPerPageOptions", ctx_r59.rowsPerPageOptions)("dropdownAppendTo", ctx_r59.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r59.paginatorDropdownScrollHeight)("templateLeft", ctx_r59.paginatorLeftTemplate)("templateRight", ctx_r59.paginatorRightTemplate)("currentPageReportTemplate", ctx_r59.currentPageReportTemplate)("showCurrentPageReport", ctx_r59.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    var rowData_r66 = ctx.$implicit;
    var rowIndex_r67 = ctx.index;
    var ctx_r60 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r60.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r66, rowIndex_r67));
} }
...
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r70); var ctx_r69 = ɵngcc0.ɵɵnextContext(); return ctx_r69.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r62 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r62.rows)("first", ctx_r62.first)("totalRecords", ctx_r62.totalRecords)("pageLinkSize", ctx_r62.pageLinks)("alwaysShow", ctx_r62.alwaysShowPaginator)("rowsPerPageOptions", ctx_r62.rowsPerPageOptions)("dropdownAppendTo", ctx_r62.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r62.paginatorDropdownScrollHeight)("templateLeft", ctx_r62.paginatorLeftTemplate)("templateRight", ctx_r62.paginatorRightTemplate)("currentPageReportTemplate", ctx_r62.currentPageReportTemplate)("showCurrentPageReport", ctx_r62.showCurrentPageReport);
} }

...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r149.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r156); var ctx_r155 = ɵngcc0.ɵɵnextContext(); return ctx_r155.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r150 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r150.rows)("first", ctx_r150.first)("totalRecords", ctx_r150.totalRecords)("pageLinkSize", ctx_r150.pageLinks)("alwaysShow", ctx_r150.alwaysShowPaginator)("rowsPerPageOptions", ctx_r150.rowsPerPageOptions)("dropdownAppendTo", ctx_r150.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r150.paginatorDropdownScrollHeight)("templateLeft", ctx_r150.paginatorLeftTemplate)("templateRight", ctx_r150.paginatorRightTemplate)("currentPageReportTemplate", ctx_r150.currentPageReportTemplate)("showCurrentPageReport", ctx_r150.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    var rowData_r157 = ctx.$implicit;
    var rowIndex_r158 = ctx.index;
    var ctx_r151 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r151.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r157, rowIndex_r158));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r152.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r161); var ctx_r160 = ɵngcc0.ɵɵnextContext(); return ctx_r160.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r153 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r153.rows)("first", ctx_r153.first)("totalRecords", ctx_r153.totalRecords)("pageLinkSize", ctx_r153.pageLinks)("alwaysShow", ctx_r153.alwaysShowPaginator)("rowsPerPageOptions", ctx_r153.rowsPerPageOptions)("dropdownAppendTo", ctx_r153.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r153.paginatorDropdownScrollHeight)("templateLeft", ctx_r153.paginatorLeftTemplate)("templateRight", ctx_r153.paginatorRightTemplate)("currentPageReportTemplate", ctx_r153.currentPageReportTemplate)("showCurrentPageReport", ctx_r153.showCurrentPageReport);
} }

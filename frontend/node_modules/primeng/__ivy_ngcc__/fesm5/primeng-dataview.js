...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r133.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r140); var ctx_r139 = ɵngcc0.ɵɵnextContext(); return ctx_r139.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r134 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r134.rows)("first", ctx_r134.first)("totalRecords", ctx_r134.totalRecords)("pageLinkSize", ctx_r134.pageLinks)("alwaysShow", ctx_r134.alwaysShowPaginator)("rowsPerPageOptions", ctx_r134.rowsPerPageOptions)("dropdownAppendTo", ctx_r134.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r134.paginatorDropdownScrollHeight)("templateLeft", ctx_r134.paginatorLeftTemplate)("templateRight", ctx_r134.paginatorRightTemplate)("currentPageReportTemplate", ctx_r134.currentPageReportTemplate)("showCurrentPageReport", ctx_r134.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    var rowData_r141 = ctx.$implicit;
    var rowIndex_r142 = ctx.index;
    var ctx_r135 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r135.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r141, rowIndex_r142));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r136.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r145); var ctx_r144 = ɵngcc0.ɵɵnextContext(); return ctx_r144.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r137 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r137.rows)("first", ctx_r137.first)("totalRecords", ctx_r137.totalRecords)("pageLinkSize", ctx_r137.pageLinks)("alwaysShow", ctx_r137.alwaysShowPaginator)("rowsPerPageOptions", ctx_r137.rowsPerPageOptions)("dropdownAppendTo", ctx_r137.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r137.paginatorDropdownScrollHeight)("templateLeft", ctx_r137.paginatorLeftTemplate)("templateRight", ctx_r137.paginatorRightTemplate)("currentPageReportTemplate", ctx_r137.currentPageReportTemplate)("showCurrentPageReport", ctx_r137.showCurrentPageReport);
} }

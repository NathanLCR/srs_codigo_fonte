...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r114.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r121); var ctx_r120 = ɵngcc0.ɵɵnextContext(); return ctx_r120.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r115 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r115.rows)("first", ctx_r115.first)("totalRecords", ctx_r115.totalRecords)("pageLinkSize", ctx_r115.pageLinks)("alwaysShow", ctx_r115.alwaysShowPaginator)("rowsPerPageOptions", ctx_r115.rowsPerPageOptions)("dropdownAppendTo", ctx_r115.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r115.paginatorDropdownScrollHeight)("templateLeft", ctx_r115.paginatorLeftTemplate)("templateRight", ctx_r115.paginatorRightTemplate)("currentPageReportTemplate", ctx_r115.currentPageReportTemplate)("showCurrentPageReport", ctx_r115.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    var rowData_r122 = ctx.$implicit;
    var rowIndex_r123 = ctx.index;
    var ctx_r116 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r116.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r122, rowIndex_r123));
} }
...
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r126); var ctx_r125 = ɵngcc0.ɵɵnextContext(); return ctx_r125.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r118 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r118.rows)("first", ctx_r118.first)("totalRecords", ctx_r118.totalRecords)("pageLinkSize", ctx_r118.pageLinks)("alwaysShow", ctx_r118.alwaysShowPaginator)("rowsPerPageOptions", ctx_r118.rowsPerPageOptions)("dropdownAppendTo", ctx_r118.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r118.paginatorDropdownScrollHeight)("templateLeft", ctx_r118.paginatorLeftTemplate)("templateRight", ctx_r118.paginatorRightTemplate)("currentPageReportTemplate", ctx_r118.currentPageReportTemplate)("showCurrentPageReport", ctx_r118.showCurrentPageReport);
} }

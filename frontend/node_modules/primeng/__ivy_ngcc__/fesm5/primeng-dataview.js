...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r108.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r115); var ctx_r114 = ɵngcc0.ɵɵnextContext(); return ctx_r114.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r109 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r109.rows)("first", ctx_r109.first)("totalRecords", ctx_r109.totalRecords)("pageLinkSize", ctx_r109.pageLinks)("alwaysShow", ctx_r109.alwaysShowPaginator)("rowsPerPageOptions", ctx_r109.rowsPerPageOptions)("dropdownAppendTo", ctx_r109.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r109.paginatorDropdownScrollHeight)("templateLeft", ctx_r109.paginatorLeftTemplate)("templateRight", ctx_r109.paginatorRightTemplate)("currentPageReportTemplate", ctx_r109.currentPageReportTemplate)("showCurrentPageReport", ctx_r109.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    var rowData_r116 = ctx.$implicit;
    var rowIndex_r117 = ctx.index;
    var ctx_r110 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r110.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r116, rowIndex_r117));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r111.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r120); var ctx_r119 = ɵngcc0.ɵɵnextContext(); return ctx_r119.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r112 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r112.rows)("first", ctx_r112.first)("totalRecords", ctx_r112.totalRecords)("pageLinkSize", ctx_r112.pageLinks)("alwaysShow", ctx_r112.alwaysShowPaginator)("rowsPerPageOptions", ctx_r112.rowsPerPageOptions)("dropdownAppendTo", ctx_r112.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r112.paginatorDropdownScrollHeight)("templateLeft", ctx_r112.paginatorLeftTemplate)("templateRight", ctx_r112.paginatorRightTemplate)("currentPageReportTemplate", ctx_r112.currentPageReportTemplate)("showCurrentPageReport", ctx_r112.showCurrentPageReport);
} }

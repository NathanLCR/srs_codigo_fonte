...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r41.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r48); var ctx_r47 = ɵngcc0.ɵɵnextContext(); return ctx_r47.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r42 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r42.rows)("first", ctx_r42.first)("totalRecords", ctx_r42.totalRecords)("pageLinkSize", ctx_r42.pageLinks)("alwaysShow", ctx_r42.alwaysShowPaginator)("rowsPerPageOptions", ctx_r42.rowsPerPageOptions)("dropdownAppendTo", ctx_r42.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r42.paginatorDropdownScrollHeight)("templateLeft", ctx_r42.paginatorLeftTemplate)("templateRight", ctx_r42.paginatorRightTemplate)("currentPageReportTemplate", ctx_r42.currentPageReportTemplate)("showCurrentPageReport", ctx_r42.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    var rowData_r49 = ctx.$implicit;
    var rowIndex_r50 = ctx.index;
    var ctx_r43 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r43.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r49, rowIndex_r50));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r44.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r53); var ctx_r52 = ɵngcc0.ɵɵnextContext(); return ctx_r52.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r45 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r45.rows)("first", ctx_r45.first)("totalRecords", ctx_r45.totalRecords)("pageLinkSize", ctx_r45.pageLinks)("alwaysShow", ctx_r45.alwaysShowPaginator)("rowsPerPageOptions", ctx_r45.rowsPerPageOptions)("dropdownAppendTo", ctx_r45.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r45.paginatorDropdownScrollHeight)("templateLeft", ctx_r45.paginatorLeftTemplate)("templateRight", ctx_r45.paginatorRightTemplate)("currentPageReportTemplate", ctx_r45.currentPageReportTemplate)("showCurrentPageReport", ctx_r45.showCurrentPageReport);
} }

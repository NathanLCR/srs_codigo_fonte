...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r54.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r61); var ctx_r60 = ɵngcc0.ɵɵnextContext(); return ctx_r60.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r55 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r55.rows)("first", ctx_r55.first)("totalRecords", ctx_r55.totalRecords)("pageLinkSize", ctx_r55.pageLinks)("alwaysShow", ctx_r55.alwaysShowPaginator)("rowsPerPageOptions", ctx_r55.rowsPerPageOptions)("dropdownAppendTo", ctx_r55.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r55.paginatorDropdownScrollHeight)("templateLeft", ctx_r55.paginatorLeftTemplate)("templateRight", ctx_r55.paginatorRightTemplate)("currentPageReportTemplate", ctx_r55.currentPageReportTemplate)("showCurrentPageReport", ctx_r55.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    var rowData_r62 = ctx.$implicit;
    var rowIndex_r63 = ctx.index;
    var ctx_r56 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r56.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r62, rowIndex_r63));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r57.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r66); var ctx_r65 = ɵngcc0.ɵɵnextContext(); return ctx_r65.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r58 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r58.rows)("first", ctx_r58.first)("totalRecords", ctx_r58.totalRecords)("pageLinkSize", ctx_r58.pageLinks)("alwaysShow", ctx_r58.alwaysShowPaginator)("rowsPerPageOptions", ctx_r58.rowsPerPageOptions)("dropdownAppendTo", ctx_r58.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r58.paginatorDropdownScrollHeight)("templateLeft", ctx_r58.paginatorLeftTemplate)("templateRight", ctx_r58.paginatorRightTemplate)("currentPageReportTemplate", ctx_r58.currentPageReportTemplate)("showCurrentPageReport", ctx_r58.showCurrentPageReport);
} }

...
function MenuItemContent_a_0_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r246.item.icon);
} }
...
function MenuItemContent_a_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_0_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r248); var ctx_r247 = ɵngcc0.ɵɵnextContext(); return ctx_r247.menu.itemClick($event, ctx_r247.item); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(9, _c1, ctx_r244.item.disabled));
    ɵngcc0.ɵɵattribute("href", ctx_r244.item.url || null, ɵngcc0.ɵɵsanitizeUrl)("tabindex", ctx_r244.item.disabled ? null : "0")("data-automationid", ctx_r244.item.automationId)("target", ctx_r244.item.target)("title", ctx_r244.item.title)("id", ctx_r244.item.id);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r244.item.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r244.item.label);
} }
function MenuItemContent_a_1_span_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 5);
} if (rf & 2) {
    var ctx_r249 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r249.item.icon);
} }
...
function MenuItemContent_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_1_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r251); var ctx_r250 = ɵngcc0.ɵɵnextContext(); return ctx_r250.menu.itemClick($event, ctx_r250.item); });
    ...
    ɵngcc0.ɵɵproperty("routerLink", ctx_r245.item.routerLink)("queryParams", ctx_r245.item.queryParams)("routerLinkActive", "ui-menuitem-link-active")("routerLinkActiveOptions", ctx_r245.item.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(18, _c2))("ngClass", ɵngcc0.ɵɵpureFunction1(19, _c1, ctx_r245.item.disabled))("fragment", ctx_r245.item.fragment)("queryParamsHandling", ctx_r245.item.queryParamsHandling)("preserveFragment", ctx_r245.item.preserveFragment)("skipLocationChange", ctx_r245.item.skipLocationChange)("replaceUrl", ctx_r245.item.replaceUrl)("state", ctx_r245.item.state);
    ɵngcc0.ɵɵattribute("data-automationid", ctx_r245.item.automationId)("target", ctx_r245.item.target)("id", ctx_r245.item.id)("tabindex", ctx_r245.item.disabled ? null : "0")("title", ctx_r245.item.title);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r245.item.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r245.item.label);
} }
var _c3 = ["container"];
...
function Menu_div_0_3_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r257 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, submenu_r257.visible === false));
} }
function Menu_div_0_3_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r257 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(3, _c4, submenu_r257.visible === false));
    ɵngcc0.ɵɵattribute("data-automationid", submenu_r257.automationId);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(submenu_r257.label);
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 7);
} if (rf & 2) {
    var item_r263 = ɵngcc0.ɵɵnextContext().$implicit;
    var submenu_r257 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r263.visible === false || submenu_r257.visible === false));
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r263 = ɵngcc0.ɵɵnextContext().$implicit;
    var submenu_r257 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassMap(item_r263.styleClass);
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r263)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r263.visible === false || submenu_r257.visible === false))("ngStyle", item_r263.style);
} }
function Menu_div_0_3_ng_template_0_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngIf", item_r263.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r263.separator);
} }
function Menu_div_0_3_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r257 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", submenu_r257.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !submenu_r257.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", submenu_r257.items);
} }
function Menu_div_0_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r254.model);
} }
function Menu_div_0_4_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 7);
} if (rf & 2) {
    var item_r271 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r271.visible === false));
} }
function Menu_div_0_4_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 10);
} if (rf & 2) {
    var item_r271 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassMap(item_r271.styleClass);
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r271)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r271.visible === false))("ngStyle", item_r271.style);
} }
function Menu_div_0_4_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngIf", item_r271.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r271.separator);
} }
function Menu_div_0_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r255.model);
} }
...
function Menu_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Menu_div_0_Template_div_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r277); var ctx_r276 = ɵngcc0.ɵɵnextContext(); return ctx_r276.preventDocumentDefault = true; })("@overlayAnimation.start", function Menu_div_0_Template_div_animation_overlayAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r277); var ctx_r278 = ɵngcc0.ɵɵnextContext(); return ctx_r278.onOverlayAnimationStart($event); });
    ...
    ɵngcc0.ɵɵclassMap(ctx_r252.styleClass);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(8, _c5, ctx_r252.popup))("ngStyle", ctx_r252.style)("@overlayAnimation", ɵngcc0.ɵɵpureFunction1(13, _c7, ɵngcc0.ɵɵpureFunction2(10, _c6, ctx_r252.showTransitionOptions, ctx_r252.hideTransitionOptions)))("@.disabled", ctx_r252.popup !== true);
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r252.hasSubMenu());
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r252.hasSubMenu());
} }

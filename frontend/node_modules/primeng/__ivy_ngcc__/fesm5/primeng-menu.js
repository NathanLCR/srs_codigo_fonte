...
function MenuItemContent_a_0_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r298.item.icon);
} }
...
function MenuItemContent_a_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_0_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r300); var ctx_r299 = ɵngcc0.ɵɵnextContext(); return ctx_r299.menu.itemClick($event, ctx_r299.item); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(9, _c1, ctx_r296.item.disabled));
    ɵngcc0.ɵɵattribute("href", ctx_r296.item.url || null, ɵngcc0.ɵɵsanitizeUrl)("tabindex", ctx_r296.item.disabled ? null : "0")("data-automationid", ctx_r296.item.automationId)("target", ctx_r296.item.target)("title", ctx_r296.item.title)("id", ctx_r296.item.id);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r296.item.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r296.item.label);
} }
function MenuItemContent_a_1_span_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 5);
} if (rf & 2) {
    var ctx_r301 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r301.item.icon);
} }
...
function MenuItemContent_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_1_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r303); var ctx_r302 = ɵngcc0.ɵɵnextContext(); return ctx_r302.menu.itemClick($event, ctx_r302.item); });
    ...
    ɵngcc0.ɵɵproperty("routerLink", ctx_r297.item.routerLink)("queryParams", ctx_r297.item.queryParams)("routerLinkActive", "ui-menuitem-link-active")("routerLinkActiveOptions", ctx_r297.item.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(18, _c2))("ngClass", ɵngcc0.ɵɵpureFunction1(19, _c1, ctx_r297.item.disabled))("fragment", ctx_r297.item.fragment)("queryParamsHandling", ctx_r297.item.queryParamsHandling)("preserveFragment", ctx_r297.item.preserveFragment)("skipLocationChange", ctx_r297.item.skipLocationChange)("replaceUrl", ctx_r297.item.replaceUrl)("state", ctx_r297.item.state);
    ɵngcc0.ɵɵattribute("data-automationid", ctx_r297.item.automationId)("target", ctx_r297.item.target)("id", ctx_r297.item.id)("tabindex", ctx_r297.item.disabled ? null : "0")("title", ctx_r297.item.title);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r297.item.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r297.item.label);
} }
var _c3 = ["container"];
...
function Menu_div_0_3_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r309 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, submenu_r309.visible === false));
} }
function Menu_div_0_3_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r309 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(3, _c4, submenu_r309.visible === false));
    ɵngcc0.ɵɵattribute("data-automationid", submenu_r309.automationId);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(submenu_r309.label);
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 7);
} if (rf & 2) {
    var item_r315 = ɵngcc0.ɵɵnextContext().$implicit;
    var submenu_r309 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r315.visible === false || submenu_r309.visible === false));
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r315 = ɵngcc0.ɵɵnextContext().$implicit;
    var submenu_r309 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassMap(item_r315.styleClass);
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r315)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r315.visible === false || submenu_r309.visible === false))("ngStyle", item_r315.style);
} }
function Menu_div_0_3_ng_template_0_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngIf", item_r315.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r315.separator);
} }
function Menu_div_0_3_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r309 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", submenu_r309.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !submenu_r309.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", submenu_r309.items);
} }
function Menu_div_0_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r306.model);
} }
function Menu_div_0_4_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 7);
} if (rf & 2) {
    var item_r323 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r323.visible === false));
} }
function Menu_div_0_4_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 10);
} if (rf & 2) {
    var item_r323 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassMap(item_r323.styleClass);
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r323)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r323.visible === false))("ngStyle", item_r323.style);
} }
function Menu_div_0_4_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngIf", item_r323.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r323.separator);
} }
function Menu_div_0_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r307.model);
} }
...
function Menu_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Menu_div_0_Template_div_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r329); var ctx_r328 = ɵngcc0.ɵɵnextContext(); return ctx_r328.preventDocumentDefault = true; })("@overlayAnimation.start", function Menu_div_0_Template_div_animation_overlayAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r329); var ctx_r330 = ɵngcc0.ɵɵnextContext(); return ctx_r330.onOverlayAnimationStart($event); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(8, _c5, ctx_r304.popup))("ngStyle", ctx_r304.style)("@overlayAnimation", ɵngcc0.ɵɵpureFunction1(13, _c7, ɵngcc0.ɵɵpureFunction2(10, _c6, ctx_r304.showTransitionOptions, ctx_r304.hideTransitionOptions)))("@.disabled", ctx_r304.popup !== true);
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r304.hasSubMenu());
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r304.hasSubMenu());
} }

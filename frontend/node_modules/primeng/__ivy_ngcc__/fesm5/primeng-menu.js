...
function MenuItemContent_a_0_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r151.item.icon);
} }
...
function MenuItemContent_a_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_0_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r153); var ctx_r152 = ɵngcc0.ɵɵnextContext(); return ctx_r152.menu.itemClick($event, ctx_r152.item); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(9, _c1, ctx_r149.item.disabled));
    ɵngcc0.ɵɵattribute("href", ctx_r149.item.url || null, ɵngcc0.ɵɵsanitizeUrl)("tabindex", ctx_r149.item.disabled ? null : "0")("data-automationid", ctx_r149.item.automationId)("target", ctx_r149.item.target)("title", ctx_r149.item.title)("id", ctx_r149.item.id);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r149.item.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r149.item.label);
} }
function MenuItemContent_a_1_span_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 5);
} if (rf & 2) {
    var ctx_r154 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r154.item.icon);
} }
...
function MenuItemContent_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_1_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r156); var ctx_r155 = ɵngcc0.ɵɵnextContext(); return ctx_r155.menu.itemClick($event, ctx_r155.item); });
    ...
    ɵngcc0.ɵɵproperty("routerLink", ctx_r150.item.routerLink)("queryParams", ctx_r150.item.queryParams)("routerLinkActive", "ui-menuitem-link-active")("routerLinkActiveOptions", ctx_r150.item.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(18, _c2))("ngClass", ɵngcc0.ɵɵpureFunction1(19, _c1, ctx_r150.item.disabled))("fragment", ctx_r150.item.fragment)("queryParamsHandling", ctx_r150.item.queryParamsHandling)("preserveFragment", ctx_r150.item.preserveFragment)("skipLocationChange", ctx_r150.item.skipLocationChange)("replaceUrl", ctx_r150.item.replaceUrl)("state", ctx_r150.item.state);
    ɵngcc0.ɵɵattribute("data-automationid", ctx_r150.item.automationId)("target", ctx_r150.item.target)("id", ctx_r150.item.id)("tabindex", ctx_r150.item.disabled ? null : "0")("title", ctx_r150.item.title);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r150.item.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r150.item.label);
} }
var _c3 = ["container"];
...
function Menu_div_0_3_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r162 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, submenu_r162.visible === false));
} }
function Menu_div_0_3_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r162 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(3, _c4, submenu_r162.visible === false));
    ɵngcc0.ɵɵattribute("data-automationid", submenu_r162.automationId);
    ɵngcc0.ɵɵadvance(1);
...
function Menu_div_0_3_ng_template_0_ng_template_2_li_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r168 = ɵngcc0.ɵɵnextContext().$implicit;
    var submenu_r162 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r168.visible === false || submenu_r162.visible === false));
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r168 = ɵngcc0.ɵɵnextContext().$implicit;
    var submenu_r162 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassMap(item_r168.styleClass);
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r168)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r168.visible === false || submenu_r162.visible === false))("ngStyle", item_r168.style);
} }
...
function Menu_div_0_3_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngIf", submenu_r162.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !submenu_r162.separator);
    ɵngcc0.ɵɵadvance(1);
...
function Menu_div_0_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r159.model);
} }
function Menu_div_0_4_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 7);
} if (rf & 2) {
    var item_r176 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r176.visible === false));
} }
function Menu_div_0_4_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 10);
} if (rf & 2) {
    var item_r176 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassMap(item_r176.styleClass);
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r176)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r176.visible === false))("ngStyle", item_r176.style);
} }
function Menu_div_0_4_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngIf", item_r176.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r176.separator);
} }
function Menu_div_0_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r160.model);
} }
...
function Menu_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Menu_div_0_Template_div_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r182); var ctx_r181 = ɵngcc0.ɵɵnextContext(); return ctx_r181.preventDocumentDefault = true; })("@overlayAnimation.start", function Menu_div_0_Template_div_animation_overlayAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r182); var ctx_r183 = ɵngcc0.ɵɵnextContext(); return ctx_r183.onOverlayAnimationStart($event); });
    ...
    ɵngcc0.ɵɵclassMap(ctx_r157.styleClass);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(8, _c5, ctx_r157.popup))("ngStyle", ctx_r157.style)("@overlayAnimation", ɵngcc0.ɵɵpureFunction1(13, _c7, ɵngcc0.ɵɵpureFunction2(10, _c6, ctx_r157.showTransitionOptions, ctx_r157.hideTransitionOptions)))("@.disabled", ctx_r157.popup !== true);
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r157.hasSubMenu());
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r157.hasSubMenu());
} }

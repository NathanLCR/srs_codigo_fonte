...
function ToastItem_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ToastItem_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r376); var ctx_r375 = ɵngcc0.ɵɵnextContext(); return ctx_r375.onCloseIconClick($event); })("keydown.enter", function ToastItem_a_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r376); var ctx_r377 = ɵngcc0.ɵɵnextContext(); return ctx_r377.onCloseIconClick($event); });
    ɵngcc0.ɵɵelementEnd();
} }
...
function ToastItem_ng_container_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction4(3, _c1, ctx_r373.message.severity == "info", ctx_r373.message.severity == "warn", ctx_r373.message.severity == "error", ctx_r373.message.severity == "success"));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵtextInterpolate(ctx_r373.message.summary);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r373.message.detail);
} }
...
function Toast_p_toastItem_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onClose", function Toast_p_toastItem_2_Template_p_toastItem_onClose_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r383); var ctx_r382 = ɵngcc0.ɵɵnextContext(); return ctx_r382.onMessageClose($event); })("@toastAnimation.start", function Toast_p_toastItem_2_Template_p_toastItem_animation_toastAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r383); var ctx_r384 = ɵngcc0.ɵɵnextContext(); return ctx_r384.onAnimationStart($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var msg_r380 = ctx.$implicit;
    var i_r381 = ctx.index;
    var ctx_r379 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("message", msg_r380)("index", i_r381)("template", ctx_r379.template)("@toastAnimation", undefined)("showTransformOptions", ctx_r379.showTransformOptions)("hideTransformOptions", ctx_r379.hideTransformOptions)("showTransitionOptions", ctx_r379.showTransitionOptions)("hideTransitionOptions", ctx_r379.hideTransitionOptions);
} }

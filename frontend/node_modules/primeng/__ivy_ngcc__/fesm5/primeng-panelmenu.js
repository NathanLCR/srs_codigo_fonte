...
function PanelMenuSub_ng_template_1_li_1_a_1_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var child_r216 = ɵngcc0.ɵɵnextContext(3).$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(1, _c0, !child_r216.expanded, child_r216.expanded));
} }
function PanelMenuSub_ng_template_1_li_1_a_1_span_2_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 14);
} if (rf & 2) {
    var child_r216 = ɵngcc0.ɵɵnextContext(3).$implicit;
    ɵngcc0.ɵɵproperty("ngClass", child_r216.icon);
} }
...
function PanelMenuSub_ng_template_1_li_1_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function PanelMenuSub_ng_template_1_li_1_a_1_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r227); var child_r216 = ɵngcc0.ɵɵnextContext(2).$implicit; var ctx_r226 = ɵngcc0.ɵɵnextContext(); return ctx_r226.handleClick($event, child_r216); });
    ...
    var child_r216 = ɵngcc0.ɵɵnextContext(2).$implicit;
    var ctx_r219 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(10, _c1, child_r216.disabled, child_r216.expanded));
    ɵngcc0.ɵɵattribute("href", child_r216.url, ɵngcc0.ɵɵsanitizeUrl)("tabindex", !ctx_r219.item.expanded ? null : child_r216.disabled ? null : "0")("id", child_r216.id)("aria-expanded", child_r216.expanded)("target", child_r216.target)("title", child_r216.title);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r216.items);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r216.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(child_r216.label);
} }
...
function PanelMenuSub_ng_template_1_li_1_a_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function PanelMenuSub_ng_template_1_li_1_a_2_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r235); var child_r216 = ɵngcc0.ɵɵnextContext(2).$implicit; var ctx_r234 = ɵngcc0.ɵɵnextContext(); return ctx_r234.handleClick($event, child_r216); });
    ...
    ɵngcc0.ɵɵproperty("routerLink", child_r216.routerLink)("queryParams", child_r216.queryParams)("routerLinkActive", "ui-menuitem-link-active")("routerLinkActiveOptions", child_r216.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(19, _c2))("ngClass", ɵngcc0.ɵɵpureFunction1(20, _c3, child_r216.disabled))("fragment", child_r216.fragment)("queryParamsHandling", child_r216.queryParamsHandling)("preserveFragment", child_r216.preserveFragment)("skipLocationChange", child_r216.skipLocationChange)("replaceUrl", child_r216.replaceUrl)("state", child_r216.state);
    ɵngcc0.ɵɵattribute("tabindex", !ctx_r220.item.expanded ? null : child_r216.disabled ? null : "0")("id", child_r216.id)("aria-expanded", child_r216.expanded)("target", child_r216.target)("title", child_r216.title);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r216.items);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r216.icon);
...
function PanelMenuSub_ng_template_1_li_1_p_panelMenuSub_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("item", child_r216)("expanded", child_r216.expanded)("transitionOptions", ctx_r221.transitionOptions);
} }
function PanelMenuSub_ng_template_1_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var child_r216 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassProp("ui-helper-hidden", child_r216.visible === false);
    ɵngcc0.ɵɵproperty("ngClass", child_r216.styleClass)("ngStyle", child_r216.style);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !child_r216.routerLink);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r216.routerLink);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r216.items);
...
function PanelMenuSub_ng_template_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var child_r216 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", child_r216.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !child_r216.separator);
} }
...
function PanelMenu_ng_container_1_a_3_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(1, _c8, !item_r241.expanded, item_r241.expanded));
} }
...
function PanelMenu_ng_container_1_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function PanelMenu_ng_container_1_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r252); var item_r241 = ɵngcc0.ɵɵnextContext().$implicit; var ctx_r251 = ɵngcc0.ɵɵnextContext(); return ctx_r251.handleClick($event, item_r241); });
    ...
    var item_r241 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵattribute("href", item_r241.url, ɵngcc0.ɵɵsanitizeUrl)("tabindex", item_r241.disabled ? null : "0")("id", item_r241.id)("target", item_r241.target)("title", item_r241.title)("aria-expanded", item_r241.expanded)("id", item_r241.id + "_header")("aria-controls", item_r241.id + "_content");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r241.items);
    ɵngcc0.ɵɵadvance(1);
...
function PanelMenu_ng_container_1_a_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function PanelMenu_ng_container_1_a_4_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r260); var item_r241 = ɵngcc0.ɵɵnextContext().$implicit; var ctx_r259 = ɵngcc0.ɵɵnextContext(); return ctx_r259.handleClick($event, item_r241); });
    ...
    var item_r241 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("routerLink", item_r241.routerLink)("queryParams", item_r241.queryParams)("routerLinkActive", "ui-menuitem-link-active")("routerLinkActiveOptions", item_r241.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(17, _c2))("fragment", item_r241.fragment)("queryParamsHandling", item_r241.queryParamsHandling)("preserveFragment", item_r241.preserveFragment)("skipLocationChange", item_r241.skipLocationChange)("replaceUrl", item_r241.replaceUrl)("state", item_r241.state);
    ɵngcc0.ɵɵattribute("target", item_r241.target)("title", item_r241.title)("id", item_r241.id)("tabindex", item_r241.disabled ? null : "0");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r241.items);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r241.icon);
...
function PanelMenu_ng_container_1_div_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("@rootItem.done", function PanelMenu_ng_container_1_div_5_Template_div_animation_rootItem_done_0_listener() { ɵngcc0.ɵɵrestoreView(_r264); var ctx_r263 = ɵngcc0.ɵɵnextContext(2); return ctx_r263.onToggleDone(); });
    ...
    ɵngcc0.ɵɵproperty("@rootItem", item_r241.expanded ? ɵngcc0.ɵɵpureFunction1(9, _c5, ɵngcc0.ɵɵpureFunction1(7, _c4, ctx_r246.animating ? ctx_r246.transitionOptions : "0ms")) : ɵngcc0.ɵɵpureFunction1(13, _c7, ɵngcc0.ɵɵpureFunction1(11, _c6, ctx_r246.transitionOptions)))("ngClass", ɵngcc0.ɵɵpureFunction1(15, _c9, !item_r241.expanded || ctx_r246.animating));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵattribute("id", item_r241.id + "_content")("aria-labelledby", item_r241.id + "_header");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("item", item_r241)("expanded", true)("transitionOptions", ctx_r246.transitionOptions);
} }
...
function PanelMenu_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var f_r242 = ctx.first;
    var l_r243 = ctx.last;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(8, _c10, item_r241.visible === false));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap(item_r241.styleClass);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction4(10, _c11, f_r242, l_r243 && !item_r241.expanded, item_r241.expanded, item_r241.disabled))("ngStyle", item_r241.style);
    ɵngcc0.ɵɵadvance(1);
